...
function gameover() {
    ...
    mainGame.style['background-color'] = "#fff";
    mainGame.style["height"] = "12.500rem";
    mainGame.style['padding'] = "30px";
...
function checkAnswer() {
    ...
    /* Don't grab answer from buttons if the timer has ran out */
    if (answer !== 5) {
    ...
    if (answer === theAnswer) {
        ...
        /* Don't show incorrect answer if timer has ran out */
        if (answer !== 5) {
